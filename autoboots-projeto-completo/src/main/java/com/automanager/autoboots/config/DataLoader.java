...
import com.automanager.autoboots.model.Endereco;
import com.automanager.autoboots.model.Mercadoria;
import com.automanager.autoboots.model.Servico;
import com.automanager.autoboots.model.TipoVeiculo;
...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario admin = new Usuario("Admin Master", "admin",
                passwordEncoder.encode("admin123"), "admin@autoboots.com", "ADMINISTRADOR");
        ...
        Usuario gerente = new Usuario("Carlos Gerente", "gerente",
                passwordEncoder.encode("gerente123"), "gerente@autoboots.com", "GERENTE");
        ...
        Usuario vendedor = new Usuario("Ana Vendedora", "vendedor",
                passwordEncoder.encode("vendedor123"), "vendedor@autoboots.com", "VENDEDOR");
        ...
        Usuario cliente = new Usuario("Maria Cliente", "cliente",
                passwordEncoder.encode("cliente123"), "cliente@autoboots.com", "CLIENTE");
